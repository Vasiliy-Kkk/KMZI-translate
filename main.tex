...
\SetKwComment{Comment}{/* }{ */}
    ...
    \appendix
    \include{contents/8_A_Lookup_tables}
    \include{contents/9_B_algorithms}
    \include{contents/10_C_obtain_tklog}
    \include{contents/11_D_lemma3}
    \include{contents/12_E_realisation_decomposition}
